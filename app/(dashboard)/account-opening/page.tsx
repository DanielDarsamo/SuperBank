...
export default function AccountOpeningPage() {
  ...
  const handleSubmit = async () => {
    if (!user) {
      toast.info('Please log in to submit a real application. This is a demo preview.');
      return;
    }
    ...
    <>
      ...
      >
        <div className="max-w-2xl mx-auto">
          {isExploreMode && (
            <Card className="mb-8 border-fnb-orange bg-orange-50">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">
                      You're exploring account opening features. 
                      <Link href="/login" className="text-fnb-teal hover:underline ml-1">
                        Log in
                      </Link> to submit a real application.
                    </p>
                  </div>
                </div>
              </CardContent>
            ...
            <Card>
              ...
              <CardContent className="space-y-6">
                ...
                <div className="flex space-x-4">
                  ...
                  <Button onClick={handleDocumentsNext} className="flex-1 bg-fnb-teal hover:bg-fnb-teal/90">
                    {t('next')}
                    <ArrowRight className="ml-2 w-4 h-4" />
                  </Button>
                </div>
              ...
              <CardContent className="space-y-6">
                ...
                <div className="bg-fnb-light-teal p-4 rounded-lg">
                  <p className="text-sm text-fnb-teal">
                    ...
                    and you agree to FNB's terms and conditions.
                  </p>
                </div>
                ...
                <div className="flex space-x-4">
                  ...
                  <Button onClick={handleSubmit} className="flex-1 bg-fnb-teal hover:bg-fnb-teal/90">
          ...
          {step === 'submitted' && (
            <Card>
              <CardContent className="text-center py-12">
                ...
                <Button onClick={() => router.push('/')} className="w-full bg-fnb-teal hover:bg-fnb-teal/90">
                  Return to Dashboard
                </Button>
              </CardContent>
            </Card>
